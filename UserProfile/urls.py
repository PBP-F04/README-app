...
urlpatterns = [
    ...
    path("show-profile/", show_profile_flutter, name="show_profile_flutter"),
    path(
        "create-profile-flutter/", create_profile_flutter, name="create_profile_flutter"
    ),
